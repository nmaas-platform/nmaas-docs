...
![Healthchecks logo](img/healthchecks-logo.png){ align=right }
...
![Healthchecks configuration wizard](./img/healthchecks-screenshot-01.png)
...
- `Allocated storage space` - Amount of storage to be allocated to persist data generated by this Healthchecks (default value is displayed in the placeholder, in this case 1 Gigabyte), e.g. `1`, `2` or `3`.
