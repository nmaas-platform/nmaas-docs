...
authors: 
  - Frederic Loui
date: 2020-07-26
slug: nmaas-101-deploying-oxidized
categories:
...
![Diagram](./img/003_nmaas-101-3/blog-nmaas-101-3-1.png)
...
??? note "Oxidized application deployment"
    ...
    ![Select Oxidized](./img/003_nmaas-101-3/blog-nmaas-101-3-2.png)

    - select "Deploy" 

    ![Deploy](./img/003_nmaas-101-3/blog-nmaas-101-3-3.png)

    - choose a name for your service instance, in our case we chose: "p4-oxi-srv"

    ![Instance](./img/003_nmaas-101-3/blog-nmaas-101-3-4.png)
    ...
    ![Configuration](./img/003_nmaas-101-3/blog-nmaas-101-3-5.png)
    ...
    ![Configuration](./img/003_nmaas-101-3/blog-nmaas-101-3-6.png)
...
??? note "Check that you can access Oxidized using: <svc-name>.<domain>.nmaas.eu"
    ...
    ![Instance](./img/003_nmaas-101-3/blog-nmaas-101-3-9.png)

    ![Instance](./img/003_nmaas-101-3/blog-nmaas-101-3-10.png)
