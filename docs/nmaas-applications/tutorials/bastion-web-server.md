...
- `Storage space (GB)` ***[Optional]*** - Amount of storage to be allocated to persist data generated by this Bastion Web Server instance (default value is displayed in the placeholder), e.g. `1`, `2` or `3`.