...
[nmaas 1.5.4](https://gitlab.software.geant.org/nmaas/nmaas-platform/-/tree/release/1.5.4?ref_type=heads) is a minor update containing one new feature, asynchronous Helm repository updates.
