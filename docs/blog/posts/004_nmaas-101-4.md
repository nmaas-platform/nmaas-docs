...
authors: 
  - Frederic Loui
date: 2020-07-30
slug: nmaas-101-deploying-prometheus
categories:
...
![Diagram](./img/004_nmaas-101-4/blog4-1.png)
...
??? note "Prometheus application deployment"
    ...
    - Once your domain is created and associated to your account, log into [https://vnoc.nmaas.eu](https://vnoc.nmaas.eu) as in [#001](https://docs.nmaas.eu/blog/blog1/nmaas-101-1/#overview)
    - select Prometheus application 

    ![Select Oxidized](./img/004_nmaas-101-4/blog4-1.png)

    - select "Deploy"

    ![Instance](./img/004_nmaas-101-4/blog4-2.png)
    ...
    ![Instance](./img/004_nmaas-101-4/blog4-3.png)

    ![Instance](./img/004_nmaas-101-4/blog4-4.png)
    ...
    ![Configuration](./img/004_nmaas-101-4/blog4-5.png)
    ...
    ![INPROGRESS](./img/004_nmaas-101-4/blog4-6.png)

    - After few minutes the deployment status will be set to "**Active**"

    ![INPROGRESS](./img/004_nmaas-101-4/blog4-7.png)
...
??? note "Check that you can access Prometheus using: `<svc-name>.<domain>.nmaas.eu`"
    ...
    ![ACCESS](./img/004_nmaas-101-4/blog4-10.png)

    - "Access the application" button shortcut

     ![ACCESS](./img/004_nmaas-101-4/blog4-11.png)
    ...
    ![CONSOLE](./img/004_nmaas-101-4/blog4-12.png)

    - You can check if the configured agent is reachable
    
    ![TARGET](./img/004_nmaas-101-4/blog4-13.png)
    ...
    ![TARGET](./img/004_nmaas-101-4/blog4-14.png)
