...
If you are part of an organization affiliated with your national NREN (National Research and Education Network), then you can get access to the managed nmaas instances. The GEANT project offers two managed instances of nmaas, dedicated to specific use-cases:
